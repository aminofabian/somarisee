...
export default function SiteHeader() {
  ...
  return (
    ...
    <header className="container  mx-auto sticky top-0 z-50 w-full border px-5 mt-5 rounded-md bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
    ...
    {/* <div className="bg-cyan-500 rounded-full p-1">
      ...
      <span className="font-bold text-xl">Somarize</span> */}
      </Link>
