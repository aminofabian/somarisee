...
export default function SchoolHeader() {
  ...
  return (
    <header className="container mx-auto sticky top-0 z-50 w-full border px-5 mt-5 bg-gradient-to-b from-slate-50 to-slate-100 my-5 rounded-xl shadow-lg backdrop-blur supports-[backdrop-filter]:bg-background/60">
    ...
    <NavigationMenuContent>
    <div className="w-[1000px] p-4 bg-purple-50 rounded-md mx-auto shadow-lg ring-1 ring-gray-900/5">
    <div className="flex items-center justify-between mb-4 pb-5 border-b">
    ...
    <div className="grid gap-4 md:grid-cols-3 w-8xl">
    {features.map((feature, index) => (
      ...
      <div className="p-2 bg-muted rounded-md group-hover:bg-muted/80 border border-purple-600">
      <feature.icon className="h-6 w-6 text-purple-500" />
      </div>
      <div>
      <h5 className="font-medium mb-1 group-hover:text-purple-500">
      {feature.title}
      </h5>
    ...
    <div>
    <h4 className="font-medium mb-1 text-purple-600">Get started</h4>
    <p className="text-sm text-muted-foreground">
    Explore our comprehensive set of features to transform
    your school's operations.
    </p>
    </div>
    <Button variant="secondary" className="text-purple-600">Get started</Button>
    </div>
    </div>
    </div>
    </NavigationMenuContent>
    ...
    <NavigationMenuItem>
    <Link href="/administration" legacyBehavior passHref>
    <NavigationMenuLink className="group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50">
    How It Works
    </NavigationMenuLink>
    </Link>
